...
//        currentNamePaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
//        currentMessagePaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
...
//                    currentNamePaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
    ...
    private ArrayList<TLRPC.TL_dialog> getDialogsArray() {
        ...
        //Tele Pro
            ...
            return MessagesController.getInstance().dialogsSpecialBots;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Sadegh Status
        if (drawStatus) {
            int avatarLeftMargin = AndroidUtilities.isTablet() ? 13 : 9;

            if (LocaleController.isRTL) {
                setDrawableBounds(statusBG, getMeasuredWidth() - AndroidUtilities.dp(72) + avatarLeftMargin, AndroidUtilities.dp(46), AndroidUtilities.dp(16), AndroidUtilities.dp(16));
            } else {
    ...
    private void setStatusColor() {
        ...
        } else if (s.contains(LocaleController.getString("Online", R.string.Online))) {
